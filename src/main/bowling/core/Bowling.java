 ...
 * */
 public class Bowling {
  ...
  /* record/score the ball roll event in the bowling game.
   *
   ...
   * other called Frame objects will return false. each called Frame will either 
   ...
   * frames in active play, which include the "current" frame where the current 
   * ball in the game was physically rolled as well as all preceeding frames, 
   * which include frames waiting for bonus balls as well as those that have 
   * already been fully scored. each called Frame, based on its state, has the 
   * responsibility to either record/score the roll or ignore it altogether.
   *
   ...
   * actually only reflects the tally of all fully-scored frames' scores.
   */
  public int score() {
