...
public class FrameCount {
  ...
  // would be computed not for 100 frames but for Bowling.FRAMES, the max 
  // possible # of frames in a bowling game.
  //
  ...
  // # of frames >= 0 and <= # of frames allowed in a bowling game.
